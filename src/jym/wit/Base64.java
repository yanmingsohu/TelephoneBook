// CatfoOD 2011-5-3 ÏÂÎç12:16:44 yanming-sohu@sohu.com/@qq.com
...
public class Base64 {
	...
	private static final byte[] encodingTable =
		{ (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F', (byte) 'G', (byte) 'H', (byte) 'I',
				...
				(byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3', (byte) '4',
	...
	public static String encode(byte[] data, int begin, int end) {
		byte[] n = Arrays.copyOfRange(data, begin, end);
		return new String(encode(n));
	}
